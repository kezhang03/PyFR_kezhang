...
% elif ndims == 3:
  cu[0] =  u[0]*(u[6]*divub[1][1] + u[7]*divub[1][2] + u[8]*divub[1][3]) + u[5]*v[1]*(divub[1][1] + divub[2][2] + divub[3][3]);
  cu[1] =  u[0]*(u[6]*divub[2][1] + u[7]*divub[2][2] + u[8]*divub[2][3]) + u[5]*v[2]*(divub[1][1] + divub[2][2] + divub[3][3]);
  cu[2] =  u[0]*(u[6]*divub[3][1] + u[7]*divub[3][2] + u[8]*divub[3][3]) + u[5]*v[3]*(divub[1][1] + divub[2][2] + divub[3][3]);
  cu[3] =  (${c['gamma'] - 1})*u[4]*(divub[1][1] + divub[2][2] + divub[3][3]) + (${1 - c['gamma']})*(v[1]*divub[4][1] + v[2]*divub[4][2] + v[3]*divub[4][3]);
% endif
</%pyfr:kernel>